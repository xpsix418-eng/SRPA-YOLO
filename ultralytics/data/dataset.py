...
class YOLODataset(BaseDataset):
    ...
    def close_mosaic(self, hyp: dict) -> None:
        ...
        hyp.mosaic = 0.0
        hyp.copy_paste = 0.0
        hyp.small_object_copy_paste = 0.0
        hyp.mixup = 0.0
        hyp.cutmix = 0.0
        self.transforms = self.build_transforms(hyp)

    def close_small_object_copy_paste(self, hyp: dict) -> None:
        """Disable only detection small-object copy-paste and rebuild transforms."""
        hyp.small_object_copy_paste = 0.0
        self.transforms = self.build_transforms(hyp)
