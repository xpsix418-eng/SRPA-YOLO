...
class BaseTrainer:
    ...
    def _do_train(self):
        ...
        small_copy_end = self.args.small_object_copy_paste_end_epoch
        if small_copy_end and epoch >= small_copy_end:
            self._close_dataloader_small_object_copy_paste()
        ...
        while True:
            ...
            if epoch == (self.epochs - self.args.close_mosaic):
                ...
                self.train_loader.reset()
            elif small_copy_end and epoch == small_copy_end:
                self._close_dataloader_small_object_copy_paste()
                self.train_loader.reset()
    ...
    def _close_dataloader_small_object_copy_paste(self):
        """Disable only small-object copy-paste in the training dataset."""
        if hasattr(self.train_loader.dataset, "close_small_object_copy_paste"):
            LOGGER.info("Closing dataloader small-object copy-paste")
            self.train_loader.dataset.close_small_object_copy_paste(hyp=copy(self.args))
